...
class CreditCardFrom(FlaskForm):
    ...
    ownerName = StringField(label='Owner name: ', validators=[Length(min = 3, max = 20),DataRequired()])
    expDate = StringField(label='Exp date: ', validators=[Length(min = 5, max = 5),DataRequired()])
